...
DB_PATH = os.path.abspath(os.path.join(WEB_DIR, '..', 'data', 'dataBase', 'user_management.db'))
...
async def get_users_range(start, end, sort_by=None, sort_order=None):
    try:
        ...
        print(f"Error in get_users_range: {e}")
        return []
...
async def search_users_by_id(search_str, start, end, sort_by=None, sort_order=None):
    try:
        ...
        print(f"Error in search_users_by_id: {e}")
        return []
...
async def get_user_signed_days(limit=10):
    try:
        ...
        print(f"Error in get_user_signed_days: {e}")
        return []
